...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler
{
		...
		public ResponseEntity<ResponseStructure<String>> idNotFoundExecepEntity(IdNotFound id)  //idNotFoundExceptionHandler(IdNotFound ex)
		{                                                                                       
		...
		public ResponseEntity<ResponseStructure<String>> dataNotFound(DataNotFound data)
		{
			...
			structure.setStatus(HttpStatus.NOT_FOUND.value());
			structure.setData("Data Not Available");   
			return new ResponseEntity<ResponseStructure<String>>(structure,HttpStatus.NOT_FOUND);
		}
